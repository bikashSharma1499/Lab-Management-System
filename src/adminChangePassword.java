    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         String getPassFromDB="";
          ...
          try{    //Creating Connection to Data Base
                  ...
                  pst=con.prepareStatement("select pass from ocacAdmin where userid=?");
                  ...
                  String userid11="admin";
                  pst=con.prepareStatement("update ocacAdmin set pass=? where userid=?");
                    pst.setString(1, inputPass);
                    pst.setString(2,userid11);  
                   pst.executeQuery();
